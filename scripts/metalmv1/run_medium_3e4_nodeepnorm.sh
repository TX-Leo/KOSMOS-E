...
export branch=gptmodel_medium-lr3e-4-bs512-reset-wd0.01-mlmdrop-warm10k-fxeos-fxfinal-mask-gpt-scratch-nodeepnorm-no_aphla-nogithub-noarvix-nopubmed-mtnlg
