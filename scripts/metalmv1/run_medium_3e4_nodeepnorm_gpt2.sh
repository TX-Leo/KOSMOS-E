...
export branch=gptmodel_medium-lr3e-4-bs512-reset-wd0.01-mlmdrop-warm10k-fxeos-fxfinal-mask-gpt-scratch-nodeepnorm-no_aphla-nogithub-noarvix-nopubmed-mtnlg-gpt2_tok

python -m torch.distributed.launch --nproc_per_node=8 --nnodes=16  \
    ...
    --seed 1 \
    --dict-path /mnt/msranlp/yaru/data/roberta_model/roberta.base/dict.txt \
    --gpt2-vocab-bpe /mnt/msranlp/yaru/data/openwebtext2/vocab.bpe  \
    --gpt2-encoder-json /mnt/msranlp/yaru/data/openwebtext2/encoder.json \
    --save-dir /mnt/msranlp/shaohanh/exp/unitask_exp/${branch}/ \
    --tensorboard-logdir /mnt/msranlp/shaohanh/exp/unitask_exp/${branch}/tb-logs \
    --ddp-backend=legacy_ddp \
    --distributed-no-spawn \
    --batch-read-ahead 100 \
    --reset-dataloader \
    --mlm-tokens-proportion 0
