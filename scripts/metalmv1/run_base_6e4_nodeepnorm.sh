...
export branch=gptmodel_base-lr6e-4-bs512-reset-wd0.01-mlmdrop-warm500-fxeos-fxfinal-mask-gpt-scratch-nodeepnorm-no_aphla-nogithub-noarvix-nopubmed-mtnlg

python -m torch.distributed.launch --nproc_per_node=8 --nnodes=8  \
    --node_rank=$RANK --master_addr=$MASTER_ADDR --master_port=$MASTER_PORT train.py /mnt/unilm/shaohanh/data/tnlg_config/ \
