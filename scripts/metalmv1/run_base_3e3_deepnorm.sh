...
export branch=gptmodel_base-lr3e-3-bs512-reset-wd0.01-mlmdrop-warm500-fxeos-fxfinal-mask-gpt-scratch-deepnorm-no_aphla-nogithub-noarvix-nopubmed-mtnlg
