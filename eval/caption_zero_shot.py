    ...
    def convert_one_line(input_str):
        ...
        for i, segment in enumerate(segments):
            if segment.startswith('[image]'):
                ...
                image_tensor = square_transform()(image)
        ...
        return token, img_src_token[0], img_gpt_input_mask
...
def make_batches(lines, cfg, task, max_positions, encode_fn):
    ...
    tokens, lengths, img_src_tokens, img_gpt_input_mask = get_interactive_tokens_and_lengths(task, lines, encode_fn)
