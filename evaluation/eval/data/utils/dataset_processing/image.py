...
class Image:
    ...
    #     img_opencv = cv2.cvtColor(img_bgr, cv2.COLOR_BGR2GRAY)
    #     return img_opencv
    ...
    def save(self,save_path):
        cv2.imwrite(save_path,cv2.cvtColor(self.img, cv2.COLOR_RGB2BGR))
...
class DepthImage(Image):
    ...
    def save(self,save_path):
        imsave(save_path, self.img.astype(np.float32))
