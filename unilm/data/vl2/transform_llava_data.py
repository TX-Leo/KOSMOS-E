...
def process_json_file(json_file_name, img_root_path):  
...
def main():  
    file_root_path = '/mnt/msranlp/zliang/data/tuning/LLaVA-Instruct-150K'
    ...
    #     process_json_file(json_file_name, img_root_path)  
