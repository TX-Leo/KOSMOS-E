...
class WildLoader(VLBaseLoader):
    ...
    def _batchify(self, lines):
        ...
        def collate(batch):
            ...
            for i, (full_tokens, image_tokens, text_input_mask, text_loss_mask) in enumerate(batch):
    ...
    def _prepare(self, _random, doc):
        ...
        return text_tokens, image_tokens, text_input_mask, text_loss_mask
    ...
    def _read_from_files(self, source_file):
        ...
        for doc_jsonstr in lines:
            ...
            start_idx = 0
            is_valid = True
            for image_item in json_obj[IMAGE_KEY]:
                text_snippet = json_obj[TEXT_KEY][start_idx:image_item['Span'][0]]
