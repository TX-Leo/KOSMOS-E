...
from unilm.data.vl2.wild_loader_v3 import WildLoader
...
@register_task("image_gpt_pretraining_wild_laion_v3", dataclass=ImageGPTPretrainingConfig)
class ImageGPTWildLaionV3Task(GPTTask):
