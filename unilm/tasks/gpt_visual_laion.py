...
class ImageGPTPretrainingConfig(GPTPretrainingConfig, WdsLoaderConfig):
    ...
    # data_weights: str = field(default="4,32,1", metadata={"help": "wild,laion,gpt"})
    input_resolution: int = field(default=224, metadata={"help": ""})

@register_task("image_gpt_pretraining_laion", dataclass=ImageGPTPretrainingConfig)
class ImageGPTLaionTask(GPTTask):
