...
class ImageGPTPretrainingConfig(GPTPretrainingConfig, WdsLoaderConfig):
    ...
    data_weights: str = field(default="4,32,1,1", metadata={"help": "wild,laion,gpt,inst"})

@register_task("gpt_text_tuning", dataclass=ImageGPTPretrainingConfig)
class ImageGPTTuningTask(GPTTask):
    ...
    def get_batch_iterator(
        ...
        # interleaved, caption, pt, instru

        concat_loader = MixLoader([vl_loader, lain_vl_loader, lm_loader, instru_lm_loader], data_weight)
